    ...
    <div id="side-nav">
        <ul id="nav">
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a onclick="xadmin.add_tab('会员列表','{{url('admin/member')}}')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>会员列表</cite></a>
                    </li>
                    <li>
                        <a onclick="xadmin.add_tab('添加会员','{{url('admin/member/create')}}')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>添加用户</cite></a>
                    </li>
                </ul>
            ...
            <li>
                ...
                <ul class="sub-menu">
                    ...
                    <li>
                        <a onclick="xadmin.add_tab('添加分类','{{ url('admin/cate/create') }}')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>添加分类</cite></a>
                    </li>
                </ul>
