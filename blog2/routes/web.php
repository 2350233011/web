<?php
//清理路由
Route::get('qingli','Home\QingliController@qingli');
...
Route::resource('home/zhongxin','Home\ZhongxinController');
Route::resource('home/article','Home\ArticleController');

//头像
Route::post('home/zhongxin/upload','Home\ZhongxinController@upload');
...
Route::get('noaccess','Admin\LoginController@noaccess');//无权限页面
