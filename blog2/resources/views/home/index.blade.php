        ...
        <div class="container two-col-container cms-with-sidebar">
                    ...
                    <section class="catlist-8 catlist clr">
                        <div class="catlist-container clr">
                            <h2 class="home-heading clr"><span class="heading-text"> {{ $v->cate_name }} </span> <a
                                        href="{{url('/lists/'.$v->cate_id)}}">+ 更多</a></h2>
                            @if(!empty($v->article))
          ...
          <article class="home-blog-entry clr">
           ...
           <div class="postlist-meta">
            ...
            <span class="postlist-meta-views">{{$n->art_tianqi}}</span>
            <span class="delim"></span>
            ...
            <div class="postlist-meta-collect collect collect-no" uid="<?php
            if (!empty(session('homeuser')->user_id)) {
                $homeuser =session('homeuser')->user_id;
                echo $homeuser;
            }
            ?>" artid="{{ $n->art_id }}"
